...
public interface IRestaurantRepository
{
    ...
    Task<(IEnumerable<Restaurant> Restaurants, int TotalCount)> GetAllMatchingAsync(string? _searchPhrase, int PageSize, int PageNumber, string? SortBy, SortDirection? sortDirection);
